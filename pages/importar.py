...
GUIA_DETALLADA = {
    "stock_sj": {
        ...
        "pasos": [
            ...
            "3️⃣  Fecha: **dejar en blanco** — muestra el stock del día de hoy, que es lo que necesitamos",
            "4️⃣  Rubro / Super Rubro: **dejar en blanco** — bajar TODOS los artículos sin excepción",
            "5️⃣  Marca / Artículo: **dejar en blanco** — sin ningún otro filtro",
            "6️⃣  Clic en Exportar / Excel → guarda el archivo",
            "7️⃣  **Renombrar** el archivo a: `SJ_stock_YYYY-MM-DD.xlsx`",
            "   ✅ Ejemplo de hoy: `SJ_stock_2026-03-15.xlsx`",
        ...
        "errores_comunes": [
            ...
            "❌ Filtrar por rubro MODULOS → se pierden todos los demás artículos del depósito",
            "❌ Poner rango de fecha → el stock ya no es de hoy sino de una fecha pasada",
        ],
    },
    "stock_lar": {
        "titulo": "📦 Stock LARREA",
        ...
        "pasos": [
            "1️⃣  Ir a Flexxus: módulo **Stock → Listado General**",
            "2️⃣  En el filtro **Depósito**, seleccionar solo: **LARREA NUEVO** (es el nombre en Flexxus)",
            "3️⃣  Fecha: **dejar en blanco** — stock del día de hoy",
            "4️⃣  Rubro / Super Rubro: **dejar en blanco** — todos los artículos sin filtro",
            "5️⃣  Marca / Artículo: **dejar en blanco**",
            "6️⃣  Exportar a Excel → guarda el archivo",
            "7️⃣  **Renombrar** a: `LAR_stock_YYYY-MM-DD.xlsx`",
            "   ✅ Ejemplo de hoy: `LAR_stock_2026-03-15.xlsx`",
        ],
        "errores_comunes": [
            "❌ Confundir LARREA con ES LOCAL — son el mismo local, verificar en Flexxus cuál usar",
            "❌ No renombrar → sistema no puede identificar el depósito",
            "❌ Poner filtro de rubro → se pierde todo lo que no sea módulos",
        ],
    },
    "stock_eslocal": {
